...
function ju_enqueue(){
    ...
    //$ver is used to determine the version of files when in dev mode to equal to time() so that browser loads them from the server and not cache
    ...
    wp_enqueue_script( 'jquery' ); //defined by wordpress
