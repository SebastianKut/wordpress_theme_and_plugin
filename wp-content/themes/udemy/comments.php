...
if( post_password_required() ){ //this check if this post requires password to view it and if user used it
    return;
}
...
<div id="respond" class="clearfix">
    ...
    <?php 
    //generates form that is pluggable so you can add fields etc with pugins
    //to make it match our static template we pass an array with html
    comment_form( [
