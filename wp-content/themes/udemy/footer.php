        ...
        <div class="container clearfix">
          ...
          <div class="col_half">
           <?php echo get_theme_mod( 'ju_footer_copyright_text' ); ?><br>
            ...
            <?php 
              if ( get_theme_mod( 'ju_header_tos_page' ) ){
            ?>

                  <a href="<?php the_permalink( get_theme_mod( 'ju_header_tos_page' ) )?>">Terms Of Use</a>
            ...
            <?php 
              if ( get_theme_mod( 'ju_header_privacy_page' ) ){
            ?>

                  <a href="<?php the_permalink( get_theme_mod( 'ju_header_privacy_page' ) )?>">Privacy Policy</a>
          ...
          <div class="col_half col_last tright">
            ...
            <?php
              ...
              <i class="icon-envelope2"></i> <?php echo get_theme_mod( 'ju_phone_handle' ); ?> <span class="middot">&middot;</span>
           ...
           ?>
            ...
            <?php
              ...
              <i class="icon-headphones"></i><?php echo get_theme_mod( 'ju_email_handle' ); ?>
